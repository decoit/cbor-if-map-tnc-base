 ...
 */
@Slf4j
public class CBORAccessRequestIpTest extends AbstractTestBase {
	...
	public void testConstructor() {
		CBORAccessRequestIp instance = new CBORAccessRequestIp(this.publisherId, this.ifMapTimestamp);

		assertEquals(IfMapNamespaces.IFMAP_METADATA, instance.getNamespace());
		assertEquals(CBORAccessRequestIp.XML_NAME, instance.getElementName());
	...
	public void testCborSerialize() throws Exception {
		...
		byte[] expResult = DatatypeConverter.parseHexBinary("84010188006F6D792D7075626C69736865722D696401C11A4ED9E8B202C482281A075BCA00030080");
