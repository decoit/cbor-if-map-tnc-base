 ...
 */
@Slf4j
public class CBORDeviceAttributeTest extends AbstractTestBase {
	...
	private final String name = "device-attribute:name";


	@Test
	public void testConstructor() {
		CBORDeviceAttribute instance = new CBORDeviceAttribute(this.publisherId, this.ifMapTimestamp, this.name);

		assertEquals(IfMapNamespaces.IFMAP_METADATA, instance.getNamespace());
		assertEquals(CBORDeviceAttribute.XML_NAME, instance.getElementName());
	...
	public void testConstructor_NullName() {
		CBORDeviceAttribute instance = new CBORDeviceAttribute(this.publisherId, this.ifMapTimestamp, null);
	}


	@Test(expected = IllegalArgumentException.class)
	public void testConstructor_EmptyName() {
		CBORDeviceAttribute instance = new CBORDeviceAttribute(this.publisherId, this.ifMapTimestamp, "");
	}
	...
	public void testCborSerialize() throws Exception {
		...
		byte[] expResult = DatatypeConverter.parseHexBinary("84010688006F6D792D7075626C69736865722D696401C11A4ED9E8B202C482281A075BCA00030184F6008075"
