 ...
 */
@Slf4j
public class CBORPurgePublisherReceivedNoDictTest {
	@Test
	public void testCborSerialize() throws Exception {
		...
		byte[] expResult = DatatypeConverter.parseHexBinary("84F67670757267655075626C697368657252656365697665648080");
