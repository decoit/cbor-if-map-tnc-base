 ...
 */
@Slf4j
public class CBORRenewSessionResultTest extends AbstractTestBase {
	@Test
	public void testConstructor() {
		CBORRenewSessionResult instance = new CBORRenewSessionResult();

		assertEquals("renewSessionResult", instance.getElementName());
	}
	...
	public void testCborSerialize() throws Exception {
		...
		byte[] expResult = DatatypeConverter.parseHexBinary("84F6078080");
