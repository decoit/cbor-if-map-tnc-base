 ...
 */
@Slf4j
public class CBORSubscribeDeleteTest extends AbstractTestBase {
	private final String name = "sub01";


	@Test
	public void testConstructor() {
		CBORSubscribeDelete instance = new CBORSubscribeDelete(this.name);
	...
	public void testConstructor_null() {
		CBORSubscribeDelete instance = new CBORSubscribeDelete(null);
	}


	@Test(expected = IllegalArgumentException.class)
	public void testConstructor_EmptyString() {
		CBORSubscribeDelete instance = new CBORSubscribeDelete("");
	}
	...
	public void testCborSerialize() throws Exception {
		...
		byte[] expResult = DatatypeConverter.parseHexBinary("84F601820065737562303180");
