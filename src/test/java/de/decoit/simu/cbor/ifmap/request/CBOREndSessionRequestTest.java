 ...
 */
@Slf4j
public class CBOREndSessionRequestTest extends AbstractTestBase {
	private final String sessionId = "my-session-id";


	@Test
	public void testConstructor() {
		CBOREndSessionRequest instance = new CBOREndSessionRequest(this.sessionId);

		assertEquals(IfMapNamespaces.IFMAP, instance.getNamespace());
		assertEquals("endSession", instance.getElementName());
	...
	public void testConstructor_null() {
		CBOREndSessionRequest instance = new CBOREndSessionRequest(null);
	}


	@Test(expected = IllegalArgumentException.class)
	public void testConstructor_EmptyString() {
		CBOREndSessionRequest instance = new CBOREndSessionRequest("");
	}
	...
	public void testCborSerialize() throws Exception {
		...
		byte[] expResult = DatatypeConverter.parseHexBinary("84000B82006D6D792D73657373696F6E2D696480");
