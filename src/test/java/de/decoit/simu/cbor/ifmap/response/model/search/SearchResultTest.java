 ...
 */
@Slf4j
public class SearchResultTest extends AbstractTestBase {
	...
	public void testConstructor() {
		...
		assertEquals("searchResult", instance.getElementName());
	...
	@Test
	public void testAddSearchResultItem() {
		SearchResult instance = new SearchResult();
		instance.addSearchResultItem(this.searchResultItems.get(0));
		instance.addSearchResultItem(this.searchResultItems.get(1));

		assertTrue(instance.getResultItems().size() == 2);
		assertEquals(this.searchResultItems.get(0), instance.getResultItems().get(0));
		assertEquals(this.searchResultItems.get(1), instance.getResultItems().get(1));
	}


	@Test(expected = IllegalArgumentException.class)
	public void testAddSearchResultItem_null() {
		SearchResult instance = new SearchResult();
		instance.addSearchResultItem(null);
	}


	@Test
	public void testRemoveSearchResultItem() {
		SearchResult instance = new SearchResult();
		instance.addSearchResultItem(this.searchResultItems.get(0));
		instance.addSearchResultItem(this.searchResultItems.get(1));

		instance.removeSearchResultItem(this.searchResultItems.get(0));
		assertTrue(instance.getResultItems().size() == 1);
		assertEquals(this.searchResultItems.get(1), instance.getResultItems().get(0));
	}


	@Test
	public void testRemoveSearchResultItem_SameTwice() {
		SearchResult instance = new SearchResult();
		instance.addSearchResultItem(this.searchResultItems.get(0));
		instance.addSearchResultItem(this.searchResultItems.get(1));
	...
	@Test
	public void testRemoveSearchResultItem_null() {
		SearchResult instance = new SearchResult();
		instance.addSearchResultItem(this.searchResultItems.get(0));
		instance.addSearchResultItem(this.searchResultItems.get(1));

		instance.removeSearchResultItem(null);
