 ...
 */
@Slf4j
public class CBORPublishReceivedTest extends AbstractTestBase {
	@Test
	public void testConstructor() {
		CBORPublishReceived instance = new CBORPublishReceived();

		assertEquals("publishReceived", instance.getElementName());
	}
	...
	public void testCborSerialize() throws Exception {
		...
		byte[] expResult = DatatypeConverter.parseHexBinary("84F6048080");
