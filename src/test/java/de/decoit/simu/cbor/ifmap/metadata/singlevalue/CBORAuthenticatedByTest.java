 ...
 */
@Slf4j
public class CBORAuthenticatedByTest extends AbstractTestBase {
	...
	public void testConstructor() {
		CBORAuthenticatedBy instance = new CBORAuthenticatedBy(this.publisherId, this.ifMapTimestamp);

		assertEquals(IfMapNamespaces.IFMAP_METADATA, instance.getNamespace());
		assertEquals(CBORAuthenticatedBy.XML_NAME, instance.getElementName());
	...
	public void testCborSerialize() throws Exception {
		...
		byte[] expResult = DatatypeConverter.parseHexBinary("84010488006F6D792D7075626C69736865722D696401C11A4ED9E8B202C482281A075BCA00030080");
