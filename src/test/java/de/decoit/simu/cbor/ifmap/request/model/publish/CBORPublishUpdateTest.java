 ...
 */
@Slf4j
public class CBORPublishUpdateTest extends AbstractTestBase {
	...
	public void testConstructor_null_IdentifierB() {
		CBORPublishUpdate instance = new CBORPublishUpdate(null, this.identifierB);
	}


	@Test(expected = IllegalArgumentException.class)
	public void testConstructor_IdentifierA_IdentifierA() {
		CBORPublishUpdate instance = new CBORPublishUpdate(this.identifierA, this.identifierA);
	}
	...
	public void testCborSerialize_SingleIdentifier() throws Exception {
		...
		byte[] expResult = DatatypeConverter.parseHexBinary("84F60082000088000284006B6D792D646E732D6E616D65020280F600808C010588006F6D792D7075626C6973"
	...
	public void testCborSerialize_TwoIdentifiers() throws Exception {
		...
		byte[] expResult = DatatypeConverter.parseHexBinary("84F6008200008C000284006B6D792D646E732D6E616D6502028000018084F60080696465766963652D3031F6"
