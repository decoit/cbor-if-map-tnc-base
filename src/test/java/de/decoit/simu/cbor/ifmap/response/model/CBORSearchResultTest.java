 ...
 */
@Slf4j
public class CBORSearchResultTest extends AbstractTestBase {
	...
	public CBORSearchResultTest() {
		...
		this.result.addSearchResultItem(this.searchResultItems.get(0));
		this.result.addSearchResultItem(this.searchResultItems.get(1));
	}


	@Test
	public void testConstructor() {
		CBORSearchResult instance = new CBORSearchResult(this.result);

		assertEquals("searchResult", instance.getElementName());
		assertEquals(this.result, instance.getResult());
	}


	@Test(expected = IllegalArgumentException.class)
	public void testConstructor_null() {
		CBORSearchResult instance = new CBORSearchResult(null);
	}
