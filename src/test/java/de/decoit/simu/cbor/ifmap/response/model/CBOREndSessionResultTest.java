 ...
 */
@Slf4j
public class CBOREndSessionResultTest extends AbstractTestBase {
	@Test
	public void testConstructor() {
		CBOREndSessionResult instance = new CBOREndSessionResult();

		assertEquals("endSessionResult", instance.getElementName());
	}
	...
	public void testCborSerialize() throws Exception {
		...
		byte[] expResult = DatatypeConverter.parseHexBinary("84F6088080");
