 ...
 */
@Slf4j
public class CBORSubscribeReceivedTest extends AbstractTestBase {
	@Test
	public void testConstructor() {
		CBORSubscribeReceived instance = new CBORSubscribeReceived();

		assertEquals("subscribeReceived", instance.getElementName());
	}
	...
	public void testCborSerialize() throws Exception {
		...
		byte[] expResult = DatatypeConverter.parseHexBinary("84F6038080");
