 ...
 */
@Slf4j
public class NotifyPollSearchResultTest extends AbstractTestBase {
	...
	public NotifyPollSearchResultTest() {
	...
	public void testConstructor() {
		NotifyPollSearchResult instance = new NotifyPollSearchResult();

		assertEquals("notifyResult", instance.getElementName());
	...
	public void testCborSerialize_NoResults() throws Exception {
		...
		byte[] expResult = DatatypeConverter.parseHexBinary("84F60382006773722D6E616D6580");
	...
	public void testCborSerialize_TwoResults() throws Exception {
		...
		byte[] expResult = DatatypeConverter.parseHexBinary("84F60382006773722D6E616D6588F6008088000284006B6D792D646E732D6E616D65020280F6008084010688"
