...
/**
 * Java representation of the IF-MAP device-ip metadata.
 *
...
@Slf4j
public class CBORDeviceIp extends AbstractSingleValueMetadata {
	public static final String XML_NAME = "device-ip";


	/**
	 * Create a new device-ip metadata.
	 ...
	 */
	public CBORDeviceIp(String ifMapPublisherId, ZonedDateTime ifMapTimestamp) {
