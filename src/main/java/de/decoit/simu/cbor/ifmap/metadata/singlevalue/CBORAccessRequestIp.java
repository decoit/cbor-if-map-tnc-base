...
/**
 * Java representation of the IF-MAP access-request-ip metadata.
 *
...
@Slf4j
public class CBORAccessRequestIp extends AbstractSingleValueMetadata {
	public static final String XML_NAME = "access-request-ip";


	/**
	 * Create a new access-request-ip metadata.
	 ...
	 */
	public CBORAccessRequestIp(String ifMapPublisherId, ZonedDateTime ifMapTimestamp) {
