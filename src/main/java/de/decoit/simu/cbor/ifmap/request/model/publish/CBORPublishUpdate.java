...
/**
 * Java representation of the IF-MAP update publish request type
 *
...
@Slf4j
public final class CBORPublishUpdate extends AbstractUpdateNotify {
	public static final String XML_NAME = "update";
	
	
	/**
	 * Create a new update publish type object with one identifier.
	 *
	 * @param identifierA Identifier to add to this publish request
	 */
	public CBORPublishUpdate(AbstractIdentifier identifierA) {
		this(identifierA, null);
	}


	/**
	 * Create a new update publish type object with one or two identifiers.
	 *
	 ...
	 */
	public CBORPublishUpdate(AbstractIdentifier identifierA, AbstractIdentifier identifierB) {
