...
/**
 * Container class for all IF-MAP responses.
 *
...
@Slf4j
public final class CBORResponse extends AbstractResponse {
	public static final String XML_NAME = "response";
	
	
	/**
	 * Create a new IF-MAP response.
	 *
	 * @param result Result contained in the response
	 */
	public CBORResponse(AbstractResult result) {
		super(XML_NAME, result);
	}
}
