...
/**
 * Java representation of the IF-MAP access-request-mac metadata.
 *
...
@Slf4j
public class CBORAccessRequestMac extends AbstractSingleValueMetadata {
	public static final String XML_NAME = "access-request-mac";


	/**
	 * Create a new access-request-mac metadata.
	 ...
	 */
	public CBORAccessRequestMac(String ifMapPublisherId, ZonedDateTime ifMapTimestamp) {
