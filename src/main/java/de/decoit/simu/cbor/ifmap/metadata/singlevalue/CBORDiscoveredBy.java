...
/**
 * Java representation of the IF-MAP discovered-by metadata.
 *
...
@Slf4j
public class CBORDiscoveredBy extends AbstractSingleValueMetadata {
	public static final String XML_NAME = "discovered-by";


	/**
	 * Create a new discovered-by metadata.
	 ...
	 */
	public CBORDiscoveredBy(String ifMapPublisherId, ZonedDateTime ifMapTimestamp) {
