...
/**
 * Java representation of the IF-MAP authenticated-as metadata.
 *
...
@Slf4j
public class CBORAuthenticatedAs extends AbstractSingleValueMetadata{
	public static final String XML_NAME = "authenticated-as";


	/**
	 * Create a new authenticated-as metadata.
	 ...
	 */
	public CBORAuthenticatedAs(String ifMapPublisherId, ZonedDateTime ifMapTimestamp) {
