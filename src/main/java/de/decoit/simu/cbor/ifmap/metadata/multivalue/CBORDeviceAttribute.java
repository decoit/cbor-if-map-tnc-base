...
/**
 * Java representation of the IF-MAP device-attribute metadata.
 *
...
@Slf4j
public class CBORDeviceAttribute extends AbstractMultiValueMetadata {
	public static final String XML_NAME = "device-attribute";
	...
	/**
	 * Create a new device-attribute metadata.
	 ...
	 */
	public CBORDeviceAttribute(String ifMapPublisherId, ZonedDateTime ifMapTimestamp, String name) {
	 ...
	 * @param name Device attribute name
	 */
	public CBORDeviceAttribute(String name) {
	...
	protected void serializeNestedElements(final ArrayBuilder<?> builder) throws CBORSerializationException {
		try {
			...
			// Serialize 'name'
			{
				DataItem cborName = this.getNestedElementNameMapping(CBORDeviceAttribute.NAME, elementEntry);
