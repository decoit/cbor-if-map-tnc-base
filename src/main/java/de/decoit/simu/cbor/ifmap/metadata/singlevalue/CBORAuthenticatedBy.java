...
/**
 * Java representation of the IF-MAP authenticated-by metadata.
 *
...
@Slf4j
public class CBORAuthenticatedBy extends AbstractSingleValueMetadata {
	public static final String XML_NAME = "authenticated-by";


	/**
	 * Create a new authorized-by metadata.
	 ...
	 */
	public CBORAuthenticatedBy(String ifMapPublisherId, ZonedDateTime ifMapTimestamp) {
